...
function c.splashEnd(f)
  ...
  c.Menu_Difficulty_Background = f.getWidgetN("root/Menu_Difficulty/Background")
  ...
  c.Banner_StageMap_Fort = f.getWidgetN("root/Game/Hud/Banner_StageMap/Frame/StageMap/Stage_Select/Fort")
  ...
  c.Menu_StageSelect_Fort = f.getWidgetN("root/Menu_StageSelect/Frame/StageMap/Stage_Select/Fort")
...
function c.difficultySelect(f, params)
  ...
  c.Menu_Difficulty_Background:scheduleFunction("hideEnd", c.stageSelectShow)
end
...
function c.stageMapUpdateButtons(f)
  ...
  if s == 14 then
    c.Banner_StageMap_Fort:show()
  else
    c.Banner_StageMap_Fort:hide()
...
function c.stageSelectUpdateButtons(f)
  ...
  if s == 14 then
    c.Menu_StageSelect_Fort:show()
  else
    c.Menu_StageSelect_Fort:hide()
    c.Menu_StageSelect_Fort:clean()
  end
end
